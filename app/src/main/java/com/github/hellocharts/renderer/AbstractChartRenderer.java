...
public abstract class AbstractChartRenderer implements ChartRenderer {
    ...
    protected void drawLabelTextAndBackground(Canvas canvas, char[] labelBuffer, int startIndex, int numChars,
        ...
        if (isValueLabelBackgroundEnabled) {
            ...
            centerX = labelBackgroundRect.centerX() + labelMargin/2;
            centerY = labelBackgroundRect.centerY() - labelMargin/2;
        } else {
            centerX = labelBackgroundRect.centerX();
            centerY = labelBackgroundRect.centerY();
        }

        canvas.drawText(labelBuffer, startIndex, numChars, centerX, centerY, labelPaint);
    }
